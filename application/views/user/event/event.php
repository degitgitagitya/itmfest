                ...
                <div class="col">
                        ...
                        <div class="row row-lg-eq-height">
                            ...
                            <div class="col-lg-6 event_col">
                                <div class="event_content">
                                    <div class="event_title">PPPP (Putra Putri Praja Pariwisata)</div>
                                    <div class="event_location">@ Gedung Ahmad Sanusi UPI</div>
                                    <div class="event_text">
                                        <p>Kontes pemilihan putra dan putri pariwisata ini ditujukan untuk siswa/i dan mahasiswa/i seluruh Indonesia. Peserta yang diharapkan merupakan perwakilan dari seluruh wilayah Indonesia tersebar dari Sabang hingga Merauke. Diharapkan peserta memiliki wawasan mengenai dunia pariwisata Indonesia dan memiliki semangat untuk terus melestarikan warisan budaya Indonesia.
                                    ...
                                    <div class="event_buttons">
                                        <div class="button_2 event_button event_button_2"><a href="<?php echo base_url('Event/eventDetailPPP') ?>">Read more</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="event">
                        <div class="row row-lg-eq-height">
                            ...
                            <div class="col-lg-6 event_col">
                                <div class="event_content">
                                    <div class="event_title">Seminar</div>
                                    <div class="event_location">@ Gedung Ahmad Sanusi UPI</div>
                                    <div class="event_text">
                                        <p>Seminar ini bertajuk “The Power of Digital Marketing for Sustainable of Coffee Tourism in Indonesia”. Seminar ini akan dihadiri oleh 3 Speakers terkenal Indonesia, dan diadakan pada hari Rabu 1 Mei 2019 pukul 12.30-17.30 WIB di Gedung Ahmad Sanusi UPI Bandung. Diharapkan, setelah mengikuti seminar ini mahasiswa/i pariwisata Indonesia dapat mengembangkan pariwisata Indonesia dengan style yang dapat menarik perhatian masyarakat lokal maupun Internasional.
                                        </p>
                                    </div>
                                    <div class="event_buttons">
                                        <div class="button_2 event_button event_button_2"><a href="<?php echo base_url('Event/eventDetailSeminar') ?>">Read more</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
